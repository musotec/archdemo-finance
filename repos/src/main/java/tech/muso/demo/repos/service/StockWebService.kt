package tech.muso.demo.repos.service
 ...
 */
internal class StockWebService : StockService {
    ...
    override suspend fun getAllStocks(): List<Stock> = withContext(Dispatchers.Default) {
        val result = stockWebService.getAllStocks()
        result.shuffled()
    }

    override suspend fun getUserStocks(): List<Stock> = withContext(Dispatchers.Default) {
