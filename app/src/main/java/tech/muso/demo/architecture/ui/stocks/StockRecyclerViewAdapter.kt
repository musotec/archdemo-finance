...
import tech.muso.demo.architecture.databinding.ListItemStockCardViewBinding
...
class StockRecyclerViewAdapter(private val viewClickCallback: ((Stock) -> Unit)? = null) : ListAdapter<Stock, RecyclerView.ViewHolder>(StockDiffCallback()) {
    ...
    class StockItemViewHolder(
        ...
        fun bind(item: Stock, viewClickCallback: ((Stock) -> Unit)? = null) {
            binding.apply {
